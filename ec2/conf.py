...
DEFAULT_EC2_SPARK_ARGS = {'--instance-type': 't2.micro',
                    ...
                    '--ami': 'ami-12a66771'}
DEFAULT_EC2_CLI_ARGS = {'--image-id': 'ami-12a66771', #cab869a9',#94b667f7',#ddb869be',#04b96867',#12a66771',#0c87566f',
                    '--count': '1',
...
def parse_args():
    ...
    if submit_script in caller:
        parser.add_argument('--hdfs', action='store_true', default=False, help='[FOR SUBMIT]: add this flag if copying from S3 into hdfs')
